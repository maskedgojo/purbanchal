    ...
    <div class="max-w-7xl mx-auto px-8 lg:px-20 py-10">
      ...
      <div class="grid grid-cols-4 gap-10 text-sm text-slate-200">
        ...
        <a href="#" class="block group">
          <img src="/src/textures/cement-01.png" alt="Ordinary Portland Cement"
        ...
        <!-- ===== card 2 ===== -->
        <a href="#" class="block group">
          <img src="/src/textures/cement-02.png" alt="Portland Pozzolana Cement"
               class="w-full h-32 object-contain bg-[#12151c] rounded-md mb-3
                      transition-transform duration-300 group-hover:scale-105">
          <h5 class="text-yellow-400 font-semibold uppercase tracking-wide">
            PPC
        ...
        <!-- ===== card 3 ===== -->
        <a href="#" class="block group">
          <img src="/src/textures/home-opc.png" alt="Composite Cement"
               class="w-full h-32 object-contain bg-[#12151c] rounded-md mb-3
                      transition-transform duration-300 group-hover:scale-105">
          <h5 class="text-yellow-400 font-semibold uppercase tracking-wide">
            OPC
        ...
        <!-- ===== card 4 ===== -->
        <a href="#" class="block group">
          <img src="/src/textures/truck.png" alt="Sulphate Resistant Cement"
               class="w-full h-32 object-contain bg-[#12151c] rounded-md mb-3
                      transition-transform duration-300 group-hover:scale-105">
          <h5 class="text-yellow-400 font-semibold uppercase tracking-wide">
            Fresh Bulk Cement
...
setupMegaMenuInteractivity() {
  const categoryData = {
    ...
    'technical-services': {
      ...
      image: '/src/textures/WhatsApp-Image-2024-04-16-at-19.00.28.jpeg',
    ...
    'rmg': {
      ...
      image: '/src/textures/WhatsApp-Image-2024-08-29-at-17.04.08-1.jpeg',
    ...
    'outdoor': {
      ...
      image: '/src/textures/OUTDOOR.jpg',
    ...
    'inshop': {
      ...
      image: '/src/textures/cement-02.png',
    ...
    'clinker-manufacturing': {
      ...
      image: '/src/textures/CLINKER.jpg',
    ...
    'cement-grinding': {
      ...
      image: '/src/textures/grinding-process.jpg',
    ...
    'process-flow': {
      ...
      image: '/src/textures/PROCESS.jpg',
      title: 'Process Flow',
    ...
    'quality-control': {
      ...
      image: '/src/textures/cement-01.png',
