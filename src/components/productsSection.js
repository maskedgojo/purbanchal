       ...
       <section class="py-20 px-14 sm:px-8 lg:px-24 mr-2 -ml-4 bg-gray-200 font-['Poppins']">
        <<div class="max-w-7xl mx-auto opacity-0 translate-y-10 transition-all duration-1000 ease-[cubic-bezier(0.25,1,0.5,1)] product-section-trigger">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ${this.createCard("/cement-01.png", "Surya Concretic", "By supplying factory fresh cement to the big construction sites...", 0)}
            ${this.createCard("/cement-02.png", "Surya PPC", "PPC or Portland Pozzolana Cement is a kind of blended cement...", 100)}
            ${this.createCard("/home-opc.png", "Surya OPC", "Ordinary Portland Cement (OPC) is a product obtained by intimately....", 200)}
            ${this.createCard("/truck.png", "Fresh Bulk Cement", "By supplying factory fresh cement to the big construction sites...", 300)}
          </div>
